...
<html><head>
    ...
    <body>
         <form method="post" action="upsalary.php">
    <ul>
    <li><a>Account</a>
        <ul>
  ...
  <br> <br><br><br>  <br><br><br>  <br><br><br>
               <?php include('errors.php'); ?>
                ...
                <label>Update Salary:</label><br>
                 <input type="number" name="sal" id="ad" placeholder="Enter Salary" required=""><br>
                
                 
                <input type="Submit" name="salsubmit" value="Submit" style="width: 75px; height: 25px;">
